...
import { createBlog, getCategorias, getBlog, updateBlog } from "../../../../core/apiCore";
...
const NoticiaEditar = ({ slug }) => {
  ...
  const { categorias, categories, noticia, selectedValues, title, subTitle, error, errorMsg, formData, redirectToReferrer } = values;
  const handleBody = (e) => {
    console.log(e);
    setBody(e);
    formData.set("body", e);
